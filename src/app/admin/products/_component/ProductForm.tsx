...
import { addProducts, updateProducts } from "../../_action/products";
import { useFormStatus } from "react-dom";
import { Product } from "@prisma/client";
import Image from "next/image";

export function ProductForm({product}: {product?: Product | null}) {
    const [error, action] = useActionState(product == null? addProducts : updateProducts.bind(null,product.id),{})
  ...
  return <>
    ...
    <div className="space-y-2">
        ...
        {product != null && <Image src={product.imagePath} height="300" width="300" alt="Product Image" />}
